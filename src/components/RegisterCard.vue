  ...
  <section class="min-h-screen flex flex-col">
            ...
            <div class="flex flex-1 items-center justify-center">
                <div class="px-4 lg:px-24 py-16 lg:max-w-xl sm:max-w-md w-full text-center">
                    ...
                    <form class="text-center" v-if="!success" method="post" @submit.prevent="register">
                        <div class="py-2 text-left">
                            <input v-model="username" type="text" class="bg-gray-200 border-2 border-gray-100 focus:outline-none bg-gray-100 block w-full py-2 px-4 rounded-lg focus:border-gray-700 " placeholder="Username" />
                        </div>
                        <div class="py-2 text-left">
                            <input v-model="email" type="email" class="bg-gray-200 border-2 border-gray-100 focus:outline-none bg-gray-100 block w-full py-2 px-4 rounded-lg focus:border-gray-700 " placeholder="Email" />
                        </div>
                        <div class="py-2 text-left">
                            <input v-model="password" type="password" class="bg-gray-200 border-2 border-gray-100 focus:outline-none bg-gray-100 block w-full py-2 px-4 rounded-lg focus:border-gray-700 " placeholder="Password" />
                        </div>
                        <div class="py-2">
                    ...
                    <div class="text-center mt-12">
                        ...
                        <NuxtLink to="/login" class="font-light text-md text-indigo-600 underline font-semibold hover:text-indigo-800">Log in</NuxtLink>
                    </div>
                </div>
            </div>
        </section>
